...
enum ErrorCodes
{
    ...
    DEBUGGER_ERROR_NPT_COULD_NOT_SPLIT_THE_LARGE_PAGE_TO_4KB_PAGES,
    DEBUGGER_ERROR_NPT_FAILED_TO_GET_PML1_ENTRY_OF_TARGET_ADDRESS,
    DEBUGGER_ERROR_NPT_MULTIPLE_HOOKS_IN_A_SINGLE_PAGE,
    DEBUGGER_ERROR_COULD_NOT_BUILD_THE_NPT_HOOK,
    ...
    DEBUGGER_ERROR_PROCESS_ID_CANNOT_BE_SPECIFIED_WHILE_APPLYING_EVENT_FROM_SVM_ROOT_MODE,
    DEBUGGER_ERROR_INSTANT_EVENT_PREALLOCATED_BUFFER_IS_NOT_ENOUGH_FOR_EVENT_AND_CONDTIONALS,
