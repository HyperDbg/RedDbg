...
namespace ImGui
{
    ...
    IMGUI_API void          TableNextRow(ImGuiTableRowFlags row_flags = 0, float min_row_height = 0.0f, unsigned long long* ItemCount = nullptr); // append into the first cell of a new row.
