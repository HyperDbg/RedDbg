...
#include "HyperVisor/Npt/HookKernelCommon.hpp"
...
namespace SvmDbg { HyperVisorSvm objHyperVisorSvm; }
//Log objLog;
//File objFile;
//Trace objTrace;
...
//			break;
//		}
//		case SVM::SVM_EXIT_CODE::VMEXIT_VMMCALL:
//		{
//			break;
//		}
//		}
...
{
	//NTSTATUS status = InitializeHook();
	UNREFERENCED_PARAMETER(DeviceObject);
	SvmDbg::objHyperVisorSvm.PInterceptions = &Interceptions;
	SvmDbg::objHyperVisorSvm.PSvmVmmRun = &SvmVmmRun;

	if (SvmDbg::objHyperVisorSvm.IsSvmSupported())
	{ 
		//objFile.CreateFile(
		//	//L"\\??\\E:\\Trace.out",
		//	L"\\??\\H:\\Trace.out",
		...
		SvmDbg::objHyperVisorSvm.VirtualizeAllProcessors();
	}
